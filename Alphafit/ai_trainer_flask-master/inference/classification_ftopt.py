...
def train_squat_classifiers(trainer):
	...
	classifiers = {'bend_hips_knees': tree.DecisionTreeClassifier(criterion="entropy"), 'stance_width': linear_model.LogisticRegression(penalty='l1'),'squat_depth': linear_model.LogisticRegression(penalty='l1'),'knees_over_toes': tree.DecisionTreeClassifier( criterion="entropy"),'back_hip_angle': linear_model.LogisticRegression()}
...
def train_pushup_classifiers(trainer):
	...
	#=====[ Instantiates classifiers for each component of the squat  ]=====
	classifiers = {'head_back': linear_model.LogisticRegression(penalty='l2',C=5), 'knees_straight': linear_model.LogisticRegression(penalty='l2', C=8),'elbow_angle': linear_model.LogisticRegression(penalty='l2', C=8)}
...
# list1=['a','b']
# fp=open("list1.txt","wb")
# pt=Personal_Trainer({'squat':'NeckY','pushup':'NeckY'},)
# pickle.dump(train_squat_classifiers(pt),fp)
# fp.close